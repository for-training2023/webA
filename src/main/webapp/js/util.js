...
var Util = {
  ...
  addMenu: function() {
    ...
    var _layer$ = $(''
      ...
      + '  <ul>'
      + '    <li>'
      + '      <a href="' + contextPath + '/ja/S00001">'
      + '        <p>HOME</p>'
      + '        <img alt="HOME" class="right_arrow" src="' + contextPath + '/images/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="' + contextPath + '/ja/S00005">'
      + '        <p>作品検索</p>'
      + '        <img alt="作品検索" class="right_arrow" src="' + contextPath + '/images/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="' + contextPath + '/ja/S00007">'
      + '        <p>作曲家検索</p>'
      + '        <img alt="作曲家検索" class="right_arrow" src="' + contextPath + '/images/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="' + contextPath + '/ja/S00009">'
      + '        <p>専用アプリダウンロード</p>'
      + '        <img alt="専用アプリダウンロード" class="right_arrow" src="' + contextPath + '/images/right_arrow.png" />'
      + '      </a>'
      + '    </li>'
      + '    <li>'
      + '      <a href="https://excd.jp/" target="_blank">'
      + '        <p class="to_excd">運営会社</p>'
      + '        <img alt="運営会社" class="pop_up" src="' + contextPath + '/images/return.png" />'
      + '      </a>'
      + '    </li>'
      + '  </ul>'
      + '</div>'
