...
<script type="text/javascript" src="/js/search_song.js"></script>
<script>
$(function(){
					...
					<div class="jouken_form">
						...
						<div class="jouken_form1">
							...
							<input type="radio" id="id_release_date_radio1"
								name="release_date_radio" value="1" <%=release_date_Radio1%>>指定&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="id_release_date_radio2"
								name="release_date_radio" value="0" <%=release_date_Radio2%>>指定なし
							&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
						<div class="jouken_form2">
							...
							<p>～</p>
							<input type="date" id="id_release_date_to" name="release_date_to"
								value="<%=release_date_is_to%>">
						</div>
					</div>
				</div>
					...
					<div class="jouken_form">
						<div class="jouken_form1">
							<input type="radio" id="id_rating_radio1" name="rating_radio"
								value="1" <%=rating_radio1%>>指定
							&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
								id="id_rating_radio2" name="rating_radio" value="0"
								<%=rating_radio2%>>指定なし &nbsp;&nbsp;&nbsp;&nbsp;
						</div>
						<div class="jouken_form2">
					...
					<div class="jouken_form">
						<div class="jouken_form1">
							<input type="radio" id="id_rating_average_radio1"
								name="rating_average_radio" value="1" <%=rating_radio1%>>指定&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="id_rating_average_radio2"
								name="rating_average_radio" value="0" <%=rating_radio2%>>指定なし
							&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
						<div class="jouken_form2">
					...
					<div class="jouken_form">
						<div class="jouken_form1">
							<input type="radio" id="id_views_radio1" name="views_radio"
								value="1" <%=views_radio1%>>指定
							&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio" id="id_views_radio2"
								name="views_radio" value="0" <%=views_radio2%>>指定なし
							&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
						<div class="jouken_form2">
							...
							<p>～</p>
							<input type="text" id="id_views_to" name="views_to" maxlength='8'
								value="<%=views_to%>">
						</div>
					</div>
				</div>
					...
					<div class="jouken_form">
						<div class="jouken_form1">
							<input type="radio" id="id_song_title_radio1"
								name="song_title_radio" value="1" <%=title_radio1%>>指定&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" id="id_song_title_radio2"
								name="song_title_radio" value="0" <%=title_radio2%>>指定なし
							&nbsp;&nbsp;&nbsp;&nbsp;
						</div>
						<div class="jouken_form2">
							<input type="radio" id="id_song_title_match_radio1"
								name="song_title_match_radio" value="3" <%=title_type_radio1%>>あいまい
							<input type="radio" id="id_song_title_match_radio2"
								name="song_title_match_radio" value="4" <%=title_type_radio2%>>完全一致
							<br> <br> <input type="text" id="id_song_title_text"
