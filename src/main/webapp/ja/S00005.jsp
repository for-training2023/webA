...
}else if(release_date_Radio1 == "" && release_date_Radio2 == ""){
...
}else if(rating_radio1 == "" && rating_radio2 == ""){
...
}else if(rating_average_radio1 == "" && rating_average_radio2 == ""){
...
}else if(views_radio1 == "" && views_radio2 == ""){
...
}else if(title_radio1 == "" && title_radio2 == ""){
...
}else if(title_type_radio1 == "" && title_type_radio2 == ""){
...
<!-- 条件タイトル、フォームをまとめるdiv-->
			...
			<div class="input_table">
				<table>
							...
							<table class="radio_base">
								<tr>
									<td><input type="radio" name="release_date_radio"
										value="1" class="onOffRadio" <%= release_date_Radio1 %>><span class="radio_label">指定</span>
									</td>
									<td><input type="radio" name="release_date_radio"
					...
					<tr>
						<td class="value"><input type="date" name="release_date_from"
							value="<%= release_date_is_from %>"> <br> ～ <br> <input type="date" name="release_date_to" value="<%= release_date_is_to %>"></td>
					</tr>
				</table>
			</div>
</div>
			...
			<div class="input_table">
				<table>
							...
							<table class="radio_base">
								<tr>
									<td><input type="radio" name="rating_radio" value="1"
										class="onOffRadio" <%= rating_radio1 %>><span class="radio_label">指定</span>
									</td>
					...
					<tr>
						<td class="value"><input type="text" name="rating_from"value="<%= rating_from %>"> <br> ～ <br> <input type="text"
							name="rating_to" value="<%= rating_to %>"></td>
					</tr>
				</table>
			</div>
</div>
							...
							<table class="radio_base">
								<tr>
									<td><input type="radio" name="rating_average_radio"
										value="1" class="onOffRadio" <%= rating_average_radio1%>><span class="radio_label">指定</span>
									</td>
									<td><input  type="radio" name="rating_average_radio"
				...
				<table>
							...
							<table class="radio_base">
								<tr>
									<td><input type="radio" name="views_radio" value="1"
										class="onOffRadio"<%=views_radio1 %>><span class="radio_label">指定</span>
									</td>
					...
					<tr>
						<td class="value"><input type="text" name="views_from"
							value="<%=views_from %>"> <br> ～ <br> <input type="text"
							name="views_to" value="<%=views_to %>"></td>
					</tr>
				</table>
			</div>
</div>
				...
				<table>
					<tr>
						...
						<td class="value">
							<table class="radio_base">
								<tr>
									<td><input type="radio" onClick="checkAll()" name="title_radio" value="1"
										class="onOffRadio"<%=title_radio1 %>><span class="radio_label">指定</span>
									</td>
							...
							<table class="radio_base">
								<tr>
									...
									<td><input type="radio" name="title_type_radio"
										value="3" <%=title_type_radio1 %>><span class="radio_label" >あいまい</span></td>
									<td><input type="radio" name="title_type_radio"
										value="4" <%=title_type_radio2 %>><span class="radio_label">完全一致</span>
									</td>
								</tr>
