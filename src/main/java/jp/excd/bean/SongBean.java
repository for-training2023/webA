...
public class SongBean {
	...
	private String rating_total_formated;//総感動指数
	private String rating_average_formated;//平均感動指数
	private String total_listen_count_formated;//再生回数指数
	private String release_datetime_formated;//公開時間
